...
if [ "$SWAGGER_JSON_URL" ]; then
  sed -i "s|https://raw.githubusercontent.com/aeeem/Docs/master/docs.yml|$SWAGGER_JSON_URL|g" $INDEX_FILE
...
if [[ -f "$SWAGGER_JSON" ]]; then
  ...
  sed -i "s|https://raw.githubusercontent.com/aeeem/Docs/master/docs.yml|$REL_PATH|g" $INDEX_FILE
